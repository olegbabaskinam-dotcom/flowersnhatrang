...
IMG = [
 ("Alexandra Morozova","#8E24AA","A",
   {"ru":"2 недели назад","en":"2 weeks ago","ko":"2주 전"},
   {"ru":"Очень благодарны за оперативную доставку и связь! День в день, минута в минуту. Цветы очень порадовали маму в её День рождения. Они свежие, в прекрасном состоянии ❤️ Рекомендую данный сервис, доставили в Камрань в отель.",
    "en":"Very grateful for the prompt delivery and communication! Same day, right on the minute. The flowers really delighted my mum on her birthday. They're fresh and in perfect condition ❤️ I recommend this service — they delivered to a hotel in Cam Ranh.",
    "ko":"신속한 배달과 소통에 정말 감사드려요! 당일, 시간까지 정확했어요. 엄마 생신에 꽃이 큰 기쁨을 드렸어요. 신선하고 상태도 완벽했어요 ❤️ 이 서비스를 추천합니다 — 깜라인 호텔로 배달해 주었어요."},
   "alexandra"),
 ("Дмитрий Ясюлевич","#00695C","Д",
   {"ru":"неделю назад","en":"a week ago","ko":"1주 전"},
   {"ru":"Супер магазин цветов. Все быстро, чётко и понятно. Цветы свежие и очень красивые. Доставка быстрая и надёжная!!! Большая благодарность!!!",
    "en":"A super flower shop. Everything is fast, clear and straightforward. The flowers are fresh and very beautiful. Delivery is fast and reliable!!! Many thanks!!!",
    "ko":"최고의 꽃집이에요. 모든 게 빠르고 명확하고 이해하기 쉬워요. 꽃은 신선하고 정말 예뻐요. 배달도 빠르고 믿음직해요!!! 정말 감사합니다!!!"},
   "dmitriy-ya"),
 ("Артур Белов","#1565C0","А",
   {"ru":"неделю назад","en":"a week ago","ko":"1주 전"},
 ...
 ("Никита Гойнов","#AD1457","Н",
   {"ru":"неделю назад","en":"a week ago","ko":"1주 전"},
   {"ru":"Не ожидал такой оперативности, доставили быстро, очень красивые цветы 🤩 жена в восторге, советую. Не пожалеете 😎",
    "en":"Didn't expect such speed — delivered fast, very beautiful flowers 🤩 my wife is thrilled, I recommend it. You won't regret it 😎",
    "ko":"이렇게 빠를 줄 몰랐어요 — 신속하게 배달됐고 꽃도 정말 예뻐요 🤩 아내가 아주 좋아해요, 추천합니다. 후회 없을 거예요 😎"},
   "nikita"),
