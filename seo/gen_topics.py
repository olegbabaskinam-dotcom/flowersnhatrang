...
geo=[("Доставка цветов в отели Нячанга — как это работает","доставка цветов в отель нячанг","hotel flower delivery"),
 ...
 ("Доставка цветов ежедневно 06:00–22:00 в Нячанге: ночные заказы","доставка цветов круглосуточно нячанг","night flower delivery"),
 ("Свежие цветы в Нячанге со следующего дня","доставка цветов со следующего дня нячанг","next day delivery flowers"),
