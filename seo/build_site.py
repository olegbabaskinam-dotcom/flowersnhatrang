...
T = {
    "ru": {
        ...
        "faq_q2": "Когда возможна ближайшая доставка?",
        "faq_a2": "Онлайн-форма принимает доставку со следующего дня, слоты — с 06:00 до 21:00 (в Камрань — с 07:00 до 20:00). По Нячангу доставка бесплатная.",
        "faq_q3": "Как оплатить?",
    ...
    "en": {
        ...
        "faq_a2": "Online delivery is available from the next day, with time slots from 06:00 to 21:00 (Cam Ranh 07:00–20:00). Delivery within Nha Trang is free.",
    ...
    "ko": {
        ...
        "faq_a2": "온라인 배달은 주문 다음 날부터 가능하며, 배달 시간은 06:00~21:00(깜라인 07:00~20:00)입니다. 나트랑 시내는 무료입니다.",
        "faq_q3": "결제는 어떻게 하나요?",
...
UI = {
    "ru": {"b_fresh": "свежие цветы", "b_day": "со следующего дня",
           ...
           "f2t": "По расписанию", "f2d": "Онлайн-доставка со следующего дня, слоты 06:00–21:00 (Камрань 07:00–20:00)",
           ...
           "dl_day": "Онлайн-доставка со следующего дня, слоты 06:00–21:00 (Камрань 07:00–20:00)",
    ...
    "en": {"b_fresh": "fresh flowers", "b_day": "from the next day",
           ...
           "f2t": "Scheduled delivery", "f2d": "Online delivery from the next day, with slots from 06:00 to 21:00 (Cam Ranh 07:00–20:00)",
           "f3t": "Hotel delivery", "f3d": "If the lift works without a keycard, we come up to your room",
           "dl_free": "Free delivery across Nha Trang",
           "dl_day": "Online delivery from the next day, with slots from 06:00 to 21:00 (Cam Ranh 07:00–20:00)",
    ...
    "ko": {"b_fresh": "신선한 꽃", "b_day": "주문 다음 날부터",
           ...
           "f2t": "예약 배송", "f2d": "온라인 배달은 주문 다음 날부터, 06:00~21:00(깜라인 07:00~20:00)",
           "f3t": "호텔 배송", "f3d": "엘리베이터가 카드 없이 작동하면 객실까지 직접 올라갑니다",
           "dl_free": "나트랑 전역 무료 배송",
           "dl_day": "온라인 배달은 주문 다음 날부터, 06:00~21:00(깜라인 07:00~20:00)",
...
<head><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    ...
    <style>
        ...
        .card-img-wrap img {{ width: 100%; height: 100%; object-fit: cover; display: block; transition: transform 0.45s ease; }}
...
HOURS = {
    "ru": "Работаем ежедневно · Нячанг 06:00–21:00 · Камрань 07:00–20:00",
    "en": "Open daily · Nha Trang 06:00–21:00 · Cam Ranh 07:00–20:00",
    "ko": "매일 운영 · 나트랑 06:00–21:00 · 깜라인 07:00–20:00",
}
