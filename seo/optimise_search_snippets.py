...
CORE: dict[str, tuple[str, str, str | None]] = {
    ...
    "torty-kr.html": (
        "나트랑 케이크 주문·배달 — 500,000동부터",
        "나트랑 케이크 500,000동부터, 디저트 100,000동부터. 꽃다발·풍선·선물세트와 함께 주문할 때만 다음 날부터 배달합니다.",
        "나트랑 케이크 주문·배달",
    ),
    "nabory.html": (
...
LANDINGS: dict[str, tuple[str, str, str]] = {
    ...
    "torty-kr.html": (
        "나트랑 케이크와 디저트 배달. 케이크는 꽃다발, 풍선 또는 선물세트와 함께 주문할 때만 다음 날부터 배달합니다.",
        "나트랑 케이크·디저트<br>배달 서비스",
        "케이크는 꽃다발, 풍선 또는 선물세트와 함께 주문할 때만 다음 날부터 배달합니다.",
    ),
    "nabory.html": (
