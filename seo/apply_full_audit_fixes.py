...
def replace_business_copy(text: str) -> str:
    replacements = [
        ...
        ("Open ежедневно 07:00–22:00", "Open daily 07:00–22:00"),
        ...
        ("24/7", "ежедневно 07:00–22:00"),
        ("24×7", "ежедневно 07:00–22:00"),
        ("24 hours a day", "daily from 07:00 to 22:00"),
        ("24 hours", "daily 07:00–22:00"),
        ("24시간 운영", "매일 07:00~22:00 운영"),
        ("연중무휴", "매일 운영"),
...
def fix_ko_language_leaks(path: Path, text: str) -> str:
    ...
    if not lang_match or not lang_match.group(1).lower().startswith("ko"):
        return text
    replacements = [
        ("나트랑 꽃집·꽃배달 — 장미 꽃다발 익일배달 ежедневно 07:00–22:00", "나트랑 꽃집·꽃배달 — 장미·꽃다발, 매일 07:00–22:00"),
        ("나트랑 꽃 배달 ежедневно 07:00–22:00 — 꽃다발·장미 | NhaTrang Flowers", "나트랑 꽃 배달 — 꽃다발·장미, 매일 07:00–22:00"),
        ("ежедневно 07:00–22:00", "매일 07:00–22:00"),
        (" донгов", "동"),
